...
def display_image(IMAGE, BOX, LABEL, SCORE, FPS):
	...
	cv2.putText(IMAGE, 'wgDir=' + str(met_data['windGustDir'] if met_data['windGustDir'] else 'null'), (20,240), font, 0.5, (200,255,155), 2, cv2.LINE_AA)
	cv2.putText(IMAGE, 'fps=' + str(FPS), (20,80), font, 0.5, (200,255,155), 2, cv2.LINE_AA)
