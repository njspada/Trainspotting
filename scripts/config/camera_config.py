...
PARSER.add_argument('-conf', '--confidence', action='store', type=int, default=70, help="Detection confidence level out of 100.")
PARSER.add_argument('-dts', '--dts', action='store', type=float, default=10, help="distance tracking to stationary.")
...
PARSER.add_argument('-collect_rate_moving', '--collect_rate_moving', action='store', type=float, default=0.01, help="Logger")
